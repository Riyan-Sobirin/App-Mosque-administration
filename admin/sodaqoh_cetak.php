<?php
	...
	// deskripsi halaman
	$pagedesc = "Masjid Al Muhajirin - Bukti Kas Masuk " . format_nomor("SOD", $data['no_sodaqoh']);
		...
		<div class="container-fluid">
			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td width="2%">:</td>
						<td><?php echo format_nomor("SOD", $data['no_sodaqoh']) ?></td>
					</tr>
					<tr>
			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						<td colspan="3">&nbsp;</td>
						<td class="text-center"><?php echo format_tanggal_laporan("Jakarta", $data['tgl_sodaqoh']) ?></td>
					</tr>
