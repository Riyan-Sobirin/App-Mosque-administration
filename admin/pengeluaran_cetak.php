<?php
	...
	// deskripsi halaman
	$pagedesc = "Masjid Al Muhajirin - Bukti Kas Keluar " . format_nomor("PNG", $data['no_keluar']);
...
<body>
	...
	<section id="body-of-report">
		<div class="container-fluid">
			<h4 class="text-center">BUKTI KAS KELUAR</h4>
			<br />
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td width="2%">:</td>
						<td><?php echo format_nomor("PNG", $data['no_keluar']) ?></td>
					</tr>
					<tr>
						<td>Sudah terima dari</td>
						<td>:</td>
						<td><?php echo $data['keluar_oleh'] ?></td>
					</tr>
					<tr>
						<td>Jumlah</td>
						<td>:</td>
			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						<td colspan="3">&nbsp;</td>
						<td class="text-center"><?php echo format_tanggal_laporan("Jakarta", $data['tgl_keluar']) ?></td>
					</tr>
					<tr><td colspan="4">&nbsp;</td></tr>
					<tr>
						<td width="30%" class="text-center">Disetujui oleh</td>
						<td width="30%" class="text-center">Diserahkan oleh</td>
						<td width="10%">&nbsp;</td>
