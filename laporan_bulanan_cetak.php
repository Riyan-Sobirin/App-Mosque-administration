...
<head>
	...
	<link href="admin/dist/css/custom-report.css" rel="stylesheet">
...
<body>
				...
				<tbody>
					<tr>
						<td rowspan="3" width="16%" class="text-center">
							<img src="admin/libs/images/logo-dkm.jpg" alt="logo-dkm" width="80" />
						</td>
					...
					<tr>
						<td class="text-center">Jl. Masjid Nurul Qomar , Gg. Bakti Karya No. 3 RT 002 RW 005</td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
	...
	<script src="admin/libs/jTerbilang/jTerbilang.js"></script>
